...
import { A as REDIRECT_STATUS_CODES, C as renderEndpoint, D as ASTRO_ERROR_HEADER, E as isRoute500, F as responseSentSymbol$1, I as decodeKey, L as decryptString, M as clientAddressSymbol, N as fetchStateSymbol, O as ASTRO_GENERATOR, P as originPathnameSymbol, R as generateCspDigest, T as isRoute404, _ as isRenderInstruction, b as isAstroComponentFactory, d as renderTemplate, i as renderComponent, j as REROUTABLE_STATUS_CODES, k as DEFAULT_404_COMPONENT, l as renderSlotToString, n as renderPage, o as chunkToString, r as renderJSX, s as createSlotValueFromString, u as isRenderTemplateResult, v as normalizeCspResourceEntry, x as markHTMLString, y as pushDirective } from "./chunks/server_Yceqtf1X.mjs";
...
var middlewareSecret = "62c6c9db-73ec-4244-a3c0-485ffe27ea89";
//#endregion
...
[
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["slug"],
			"component": "src/pages/casos/[slug].astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/conversiones.astro",
			"pathname": "/conversiones",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/diseno-web.astro",
			"pathname": "/diseno-web",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/ecommerce.astro",
			"pathname": "/ecommerce",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/equipo.astro",
			"pathname": "/equipo",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/gracias.astro",
			"pathname": "/gracias",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/marca-blanca.astro",
			"pathname": "/marca-blanca",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/meta-ads.astro",
			"pathname": "/meta-ads",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/portal-cliente.astro",
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["slug"],
			"component": "src/pages/proyectos/[slug].astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/proyectos.astro",
			"pathname": "/proyectos",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
...
var _page0 = () => import("./chunks/generic_MivR4inb.mjs").then((n) => n.t);
var _page1 = () => import("./chunks/_slug__DYtDizLk.mjs");
var _page2 = () => import("./chunks/index_hObP4llA.mjs");
var _page3 = () => import("./chunks/_slug__BP32DuFg.mjs");
var _page4 = () => import("./chunks/contacto_5K5PkgOX.mjs");
var _page5 = () => import("./chunks/conversiones_BXVox82_.mjs");
var _page6 = () => import("./chunks/diseno-web_CuzkpFIT.mjs");
var _page7 = () => import("./chunks/ecommerce_B8XNccLw.mjs");
var _page8 = () => import("./chunks/equipo_l6PA2k1_.mjs");
var _page9 = () => import("./chunks/gracias_BVwclUam.mjs");
var _page10 = () => import("./chunks/marca-blanca_B5ojiM_I.mjs");
var _page11 = () => import("./chunks/meta-ads_D2EnQoXs.mjs");
var _page12 = () => import("./chunks/nosotros_CoOMK49u.mjs");
var _page13 = () => import("./chunks/portal-cliente_hnb0DooW.mjs");
var _page14 = () => import("./chunks/privacidad_K0s3oH2g.mjs");
var _page15 = () => import("./chunks/_slug__CaSLVyvM.mjs");
var _page16 = () => import("./chunks/proyectos_D_aHd8j0.mjs");
var _page17 = () => import("./chunks/seo_zwHkHkCd.mjs");
var _page18 = () => import("./chunks/index_UZtGvbYz.mjs");
var pageMap = /* @__PURE__ */ new Map([
	["node_modules/astro/dist/assets/endpoint/generic.js", _page0],
	["src/pages/blog/[slug].astro", _page1],
	["src/pages/blog/index.astro", _page2],
	["src/pages/casos/[slug].astro", _page3],
	["src/pages/contacto.astro", _page4],
	["src/pages/conversiones.astro", _page5],
	["src/pages/diseno-web.astro", _page6],
	["src/pages/ecommerce.astro", _page7],
	["src/pages/equipo.astro", _page8],
	["src/pages/gracias.astro", _page9],
	["src/pages/marca-blanca.astro", _page10],
	["src/pages/meta-ads.astro", _page11],
	["src/pages/nosotros.astro", _page12],
	["src/pages/portal-cliente.astro", _page13],
	["src/pages/privacidad.astro", _page14],
	["src/pages/proyectos/[slug].astro", _page15],
	["src/pages/proyectos.astro", _page16],
	["src/pages/seo.astro", _page17],
	["src/pages/index.astro", _page18]
]);
//#endregion
//#region \0virtual:astro:manifest
var _manifest = deserializeManifest({"rootDir":"file:///C:/Users/bdela/Desktop/Croilab/","cacheDir":"file:///C:/Users/bdela/Desktop/Croilab/node_modules/.astro/","outDir":"file:///C:/Users/bdela/Desktop/Croilab/dist/","srcDir":"file:///C:/Users/bdela/Desktop/Croilab/src/","publicDir":"file:///C:/Users/bdela/Desktop/Croilab/public/","buildClientDir":"file:///C:/Users/bdela/Desktop/Croilab/dist/client/","buildServerDir":"file:///C:/Users/bdela/Desktop/Croilab/dist/server/","adapterName":"@astrojs/vercel","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"node_modules/astro/dist/assets/endpoint/generic.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/BaseLayout.B1XsQ0Jv.css"},{"type":"inline","content":".toc-link[data-astro-cid-zg7dkzxc]{color:#00000073;border-left:2px solid #0000001f;transition:color .25s,border-color .25s}.toc-link[data-astro-cid-zg7dkzxc]:hover{color:#000;border-color:#0000004d}.toc-link[data-astro-cid-zg7dkzxc].toc-active{color:#000;border-color:#000}\n"}],"routeData":{"route":"/blog/[slug]","isIndex":false,"type":"page","pattern":"^\\/blog\\/([^/]+?)\\/?$","segments":[[{"content":"blog","dynamic":false,"spread":false}],[{"content":"slug","dynamic":true,"spread":false}]],"params":["slug"],"component":"src/pages/blog/[slug].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/BaseLayout.B1XsQ0Jv.css"}],"routeData":{"route":"/blog","isIndex":true,"type":"page","pattern":"^\\/blog\\/?$","segments":[[{"content":"blog","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/blog/index.astro","pathname":"/blog","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/BaseLayout.B1XsQ0Jv.css"},{"type":"inline","content":"@keyframes float{0%,to{transform:translateY(0)}50%{transform:translateY(-10px)}}.animate-float[data-astro-cid-6iy73elr]{animation:5s ease-in-out infinite float}\n"}],"routeData":{"route":"/casos/[slug]","isIndex":false,"type":"page","pattern":"^\\/casos\\/([^/]+?)\\/?$","segments":[[{"content":"casos","dynamic":false,"spread":false}],[{"content":"slug","dynamic":true,"spread":false}]],"params":["slug"],"component":"src/pages/casos/[slug].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/BaseLayout.B1XsQ0Jv.css"},{"type":"inline","content":"@keyframes shine{0%{transform:translate(-100%)}to{transform:translate(100%)}}\n"}],"routeData":{"route":"/contacto","isIndex":false,"type":"page","pattern":"^\\/contacto\\/?$","segments":[[{"content":"contacto","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/contacto.astro","pathname":"/contacto","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/BaseLayout.B1XsQ0Jv.css"},{"type":"inline","content":".croi-range[data-astro-cid-q4hqaued]{-webkit-appearance:none;appearance:none;background:linear-gradient(to right, #2563eb var(--fill,0%), #0000001f var(--fill,0%));cursor:pointer;border-radius:9999px;outline:none;width:100%;height:6px}.croi-range[data-astro-cid-q4hqaued]::-webkit-slider-thumb{-webkit-appearance:none;appearance:none;background:#fff;border:2px solid #2563eb;border-radius:9999px;width:22px;height:22px;transition:transform .15s;box-shadow:0 2px 10px #0000002e}.croi-range[data-astro-cid-q4hqaued]::-webkit-slider-thumb:hover{transform:scale(1.15)}.croi-range[data-astro-cid-q4hqaued]::-moz-range-thumb{cursor:pointer;background:#fff;border:2px solid #2563eb;border-radius:9999px;width:22px;height:22px;box-shadow:0 2px 10px #0000002e}.croi-range[data-astro-cid-q4hqaued]::-moz-range-track{background:#0000001f;border-radius:9999px;height:6px}@keyframes marquee{0%{transform:translate(0)}to{transform:translate(-50%)}}@keyframes marquee-reverse{0%{transform:translate(-50%)}to{transform:translate(0)}}.marquee-track[data-astro-cid-wix6qhlj]{animation:40s linear infinite marquee}.marquee-track-reverse[data-astro-cid-wix6qhlj]{animation:45s linear infinite marquee-reverse}.marquee-track[data-astro-cid-wix6qhlj]:hover,.marquee-track-reverse[data-astro-cid-wix6qhlj]:hover{animation-play-state:paused}\n@keyframes float{0%,to{transform:translateY(0)}50%{transform:translateY(-10px)}}.animate-float[data-astro-cid-6iy73elr]{animation:5s ease-in-out infinite float}\n@keyframes float{0%,to{transform:translateY(0)}50%{transform:translateY(-15px)}}@keyframes shimmer{to{transform:translate(100%)}}.animate-float{animation:6s ease-in-out infinite float}.animate-float-delayed{animation:6s ease-in-out 3s infinite float}.animate-shimmer{animation:2s linear infinite shimmer}\n"}],"routeData":{"route":"/conversiones","isIndex":false,"type":"page","pattern":"^\\/conversiones\\/?$","segments":[[{"content":"conversiones","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/conversiones.astro","pathname":"/conversiones","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/BaseLayout.B1XsQ0Jv.css"},{"type":"inline","content":".croi-range[data-astro-cid-q4hqaued]{-webkit-appearance:none;appearance:none;background:linear-gradient(to right, #2563eb var(--fill,0%), #0000001f var(--fill,0%));cursor:pointer;border-radius:9999px;outline:none;width:100%;height:6px}.croi-range[data-astro-cid-q4hqaued]::-webkit-slider-thumb{-webkit-appearance:none;appearance:none;background:#fff;border:2px solid #2563eb;border-radius:9999px;width:22px;height:22px;transition:transform .15s;box-shadow:0 2px 10px #0000002e}.croi-range[data-astro-cid-q4hqaued]::-webkit-slider-thumb:hover{transform:scale(1.15)}.croi-range[data-astro-cid-q4hqaued]::-moz-range-thumb{cursor:pointer;background:#fff;border:2px solid #2563eb;border-radius:9999px;width:22px;height:22px;box-shadow:0 2px 10px #0000002e}.croi-range[data-astro-cid-q4hqaued]::-moz-range-track{background:#0000001f;border-radius:9999px;height:6px}@keyframes marquee{0%{transform:translate(0)}to{transform:translate(-50%)}}@keyframes marquee-reverse{0%{transform:translate(-50%)}to{transform:translate(0)}}.marquee-track[data-astro-cid-wix6qhlj]{animation:40s linear infinite marquee}.marquee-track-reverse[data-astro-cid-wix6qhlj]{animation:45s linear infinite marquee-reverse}.marquee-track[data-astro-cid-wix6qhlj]:hover,.marquee-track-reverse[data-astro-cid-wix6qhlj]:hover{animation-play-state:paused}\n@keyframes float{0%,to{transform:translateY(0)}50%{transform:translateY(-10px)}}.animate-float[data-astro-cid-6iy73elr]{animation:5s ease-in-out infinite float}\n@keyframes float{0%,to{transform:translateY(0)}50%{transform:translateY(-15px)}}@keyframes shimmer{to{transform:translate(100%)}}.animate-float{animation:6s ease-in-out infinite float}.animate-float-delayed{animation:6s ease-in-out 3s infinite float}.animate-shimmer{animation:2s linear infinite shimmer}\n"}],"routeData":{"route":"/diseno-web","isIndex":false,"type":"page","pattern":"^\\/diseno-web\\/?$","segments":[[{"content":"diseno-web","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/diseno-web.astro","pathname":"/diseno-web","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/BaseLayout.B1XsQ0Jv.css"},{"type":"inline","content":".croi-range[data-astro-cid-q4hqaued]{-webkit-appearance:none;appearance:none;background:linear-gradient(to right, #2563eb var(--fill,0%), #0000001f var(--fill,0%));cursor:pointer;border-radius:9999px;outline:none;width:100%;height:6px}.croi-range[data-astro-cid-q4hqaued]::-webkit-slider-thumb{-webkit-appearance:none;appearance:none;background:#fff;border:2px solid #2563eb;border-radius:9999px;width:22px;height:22px;transition:transform .15s;box-shadow:0 2px 10px #0000002e}.croi-range[data-astro-cid-q4hqaued]::-webkit-slider-thumb:hover{transform:scale(1.15)}.croi-range[data-astro-cid-q4hqaued]::-moz-range-thumb{cursor:pointer;background:#fff;border:2px solid #2563eb;border-radius:9999px;width:22px;height:22px;box-shadow:0 2px 10px #0000002e}.croi-range[data-astro-cid-q4hqaued]::-moz-range-track{background:#0000001f;border-radius:9999px;height:6px}@keyframes marquee{0%{transform:translate(0)}to{transform:translate(-50%)}}@keyframes marquee-reverse{0%{transform:translate(-50%)}to{transform:translate(0)}}.marquee-track[data-astro-cid-wix6qhlj]{animation:40s linear infinite marquee}.marquee-track-reverse[data-astro-cid-wix6qhlj]{animation:45s linear infinite marquee-reverse}.marquee-track[data-astro-cid-wix6qhlj]:hover,.marquee-track-reverse[data-astro-cid-wix6qhlj]:hover{animation-play-state:paused}\n@keyframes float{0%,to{transform:translateY(0)}50%{transform:translateY(-10px)}}.animate-float[data-astro-cid-6iy73elr]{animation:5s ease-in-out infinite float}\n@keyframes fadeInUp{0%{opacity:0;transform:translate(-50%,20px)}to{opacity:1;transform:translate(-50%)}}@keyframes float{0%,to{transform:translateY(0)}50%{transform:translateY(-15px)}}@keyframes shimmer{to{transform:translate(100%)}}.animate-float{animation:6s ease-in-out infinite float}.animate-float-delayed{animation:6s ease-in-out 3s infinite float}.animate-shimmer{animation:2s linear infinite shimmer}\n"}],"routeData":{"route":"/ecommerce","isIndex":false,"type":"page","pattern":"^\\/ecommerce\\/?$","segments":[[{"content":"ecommerce","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/ecommerce.astro","pathname":"/ecommerce","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/BaseLayout.B1XsQ0Jv.css"},{"type":"inline","content":"@keyframes marquee{0%{transform:translate(0)}to{transform:translate(calc(-50% - 12px))}}.animate-marquee[data-astro-cid-2z43ptzp]{animation:30s linear infinite marquee}.animate-marquee[data-astro-cid-2z43ptzp]:hover{animation-play-state:paused}\n@keyframes float{0%,to{transform:translateY(0)}50%{transform:translateY(-10px)}}.animate-float[data-astro-cid-6iy73elr]{animation:5s ease-in-out infinite float}\n"}],"routeData":{"route":"/equipo","isIndex":false,"type":"page","pattern":"^\\/equipo\\/?$","segments":[[{"content":"equipo","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/equipo.astro","pathname":"/equipo","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/BaseLayout.B1XsQ0Jv.css"},{"type":"inline","content":"@keyframes fade-up{0%{opacity:0;transform:translateY(14px)}to{opacity:1;transform:translateY(0)}}.animate-fade-up[data-astro-cid-ngw7c4e2]{animation:.8s cubic-bezier(.16,1,.3,1) fade-up}@keyframes rise{0%{opacity:0;transform:translateY(110%)}1%{opacity:1}to{opacity:1;transform:translateY(0)}}.animate-rise[data-astro-cid-ngw7c4e2]{animation:1s cubic-bezier(.16,1,.3,1) rise}@keyframes drawUnderline{to{stroke-dashoffset:0}}@keyframes waShimmer{0%{transform:translate(-100%)}55%{transform:translate(100%)}to{transform:translate(100%)}}@keyframes float{0%,to{transform:translateY(0)}50%{transform:translateY(-4px)}}\n"}],"routeData":{"route":"/gracias","isIndex":false,"type":"page","pattern":"^\\/gracias\\/?$","segments":[[{"content":"gracias","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/gracias.astro","pathname":"/gracias","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/BaseLayout.B1XsQ0Jv.css"}],"routeData":{"route":"/marca-blanca","isIndex":false,"type":"page","pattern":"^\\/marca-blanca\\/?$","segments":[[{"content":"marca-blanca","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/marca-blanca.astro","pathname":"/marca-blanca","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/BaseLayout.B1XsQ0Jv.css"},{"type":"inline","content":".croi-range[data-astro-cid-q4hqaued]{-webkit-appearance:none;appearance:none;background:linear-gradient(to right, #2563eb var(--fill,0%), #0000001f var(--fill,0%));cursor:pointer;border-radius:9999px;outline:none;width:100%;height:6px}.croi-range[data-astro-cid-q4hqaued]::-webkit-slider-thumb{-webkit-appearance:none;appearance:none;background:#fff;border:2px solid #2563eb;border-radius:9999px;width:22px;height:22px;transition:transform .15s;box-shadow:0 2px 10px #0000002e}.croi-range[data-astro-cid-q4hqaued]::-webkit-slider-thumb:hover{transform:scale(1.15)}.croi-range[data-astro-cid-q4hqaued]::-moz-range-thumb{cursor:pointer;background:#fff;border:2px solid #2563eb;border-radius:9999px;width:22px;height:22px;box-shadow:0 2px 10px #0000002e}.croi-range[data-astro-cid-q4hqaued]::-moz-range-track{background:#0000001f;border-radius:9999px;height:6px}@keyframes marquee{0%{transform:translate(0)}to{transform:translate(-50%)}}@keyframes marquee-reverse{0%{transform:translate(-50%)}to{transform:translate(0)}}.marquee-track[data-astro-cid-wix6qhlj]{animation:40s linear infinite marquee}.marquee-track-reverse[data-astro-cid-wix6qhlj]{animation:45s linear infinite marquee-reverse}.marquee-track[data-astro-cid-wix6qhlj]:hover,.marquee-track-reverse[data-astro-cid-wix6qhlj]:hover{animation-play-state:paused}\n@keyframes float{0%,to{transform:translateY(0)}50%{transform:translateY(-10px)}}.animate-float[data-astro-cid-6iy73elr]{animation:5s ease-in-out infinite float}\n@keyframes float{0%,to{transform:translateY(0)}50%{transform:translateY(-15px)}}@keyframes shimmer{to{transform:translate(100%)}}@keyframes dash{to{stroke-dashoffset:0}}.animate-float{animation:6s ease-in-out infinite float}.animate-float-delayed{animation:6s ease-in-out 3s infinite float}.animate-shimmer{animation:2s linear infinite shimmer}\n"}],"routeData":{"route":"/meta-ads","isIndex":false,"type":"page","pattern":"^\\/meta-ads\\/?$","segments":[[{"content":"meta-ads","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/meta-ads.astro","pathname":"/meta-ads","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/BaseLayout.B1XsQ0Jv.css"},{"type":"inline","content":"@keyframes float{0%,to{transform:translateY(0)}50%{transform:translateY(-10px)}}.animate-float[data-astro-cid-6iy73elr]{animation:5s ease-in-out infinite float}\n"}],"routeData":{"route":"/nosotros","isIndex":false,"type":"page","pattern":"^\\/nosotros\\/?$","segments":[[{"content":"nosotros","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/nosotros.astro","pathname":"/nosotros","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/BaseLayout.B1XsQ0Jv.css"},{"type":"inline","content":"@keyframes float{0%,to{transform:translateY(0)}50%{transform:translateY(-15px)}}.animate-float[data-astro-cid-bjuuu2zg]{animation:6s ease-in-out infinite float}.custom-scrollbar[data-astro-cid-bjuuu2zg]::-webkit-scrollbar{width:6px}.custom-scrollbar[data-astro-cid-bjuuu2zg]::-webkit-scrollbar-track{background:0 0}.custom-scrollbar[data-astro-cid-bjuuu2zg]::-webkit-scrollbar-thumb{background:#ffffff1a;border-radius:10px}.custom-scrollbar[data-astro-cid-bjuuu2zg]:hover::-webkit-scrollbar-thumb{background:#fff3}\n@keyframes float{0%,to{transform:translateY(0)}50%{transform:translateY(-10px)}}.animate-float[data-astro-cid-6iy73elr]{animation:5s ease-in-out infinite float}\n"}],"routeData":{"route":"/portal-cliente","isIndex":false,"type":"page","pattern":"^\\/portal-cliente\\/?$","segments":[[{"content":"portal-cliente","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/portal-cliente.astro","pathname":"/portal-cliente","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/BaseLayout.B1XsQ0Jv.css"}],"routeData":{"route":"/privacidad","isIndex":false,"type":"page","pattern":"^\\/privacidad\\/?$","segments":[[{"content":"privacidad","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/privacidad.astro","pathname":"/privacidad","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/BaseLayout.B1XsQ0Jv.css"},{"type":"inline","content":".perspective-1000[data-astro-cid-yvw7f74v]{perspective:1000px}\n@keyframes float{0%,to{transform:translateY(0)}50%{transform:translateY(-10px)}}.animate-float[data-astro-cid-6iy73elr]{animation:5s ease-in-out infinite float}\n"}],"routeData":{"route":"/proyectos/[slug]","isIndex":false,"type":"page","pattern":"^\\/proyectos\\/([^/]+?)\\/?$","segments":[[{"content":"proyectos","dynamic":false,"spread":false}],[{"content":"slug","dynamic":true,"spread":false}]],"params":["slug"],"component":"src/pages/proyectos/[slug].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/BaseLayout.B1XsQ0Jv.css"},{"type":"inline","content":"@keyframes float{0%,to{transform:translateY(0)rotate(0)}50%{transform:translateY(-20px)rotate(5deg)}}@keyframes shine{0%{transform:translate(-100%)}to{transform:translate(100%)}}\n"}],"routeData":{"route":"/proyectos","isIndex":false,"type":"page","pattern":"^\\/proyectos\\/?$","segments":[[{"content":"proyectos","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/proyectos.astro","pathname":"/proyectos","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/BaseLayout.B1XsQ0Jv.css"},{"type":"inline","content":".croi-range[data-astro-cid-q4hqaued]{-webkit-appearance:none;appearance:none;background:linear-gradient(to right, #2563eb var(--fill,0%), #0000001f var(--fill,0%));cursor:pointer;border-radius:9999px;outline:none;width:100%;height:6px}.croi-range[data-astro-cid-q4hqaued]::-webkit-slider-thumb{-webkit-appearance:none;appearance:none;background:#fff;border:2px solid #2563eb;border-radius:9999px;width:22px;height:22px;transition:transform .15s;box-shadow:0 2px 10px #0000002e}.croi-range[data-astro-cid-q4hqaued]::-webkit-slider-thumb:hover{transform:scale(1.15)}.croi-range[data-astro-cid-q4hqaued]::-moz-range-thumb{cursor:pointer;background:#fff;border:2px solid #2563eb;border-radius:9999px;width:22px;height:22px;box-shadow:0 2px 10px #0000002e}.croi-range[data-astro-cid-q4hqaued]::-moz-range-track{background:#0000001f;border-radius:9999px;height:6px}@keyframes marquee{0%{transform:translate(0)}to{transform:translate(-50%)}}@keyframes marquee-reverse{0%{transform:translate(-50%)}to{transform:translate(0)}}.marquee-track[data-astro-cid-wix6qhlj]{animation:40s linear infinite marquee}.marquee-track-reverse[data-astro-cid-wix6qhlj]{animation:45s linear infinite marquee-reverse}.marquee-track[data-astro-cid-wix6qhlj]:hover,.marquee-track-reverse[data-astro-cid-wix6qhlj]:hover{animation-play-state:paused}\n@keyframes float{0%,to{transform:translateY(0)}50%{transform:translateY(-10px)}}.animate-float[data-astro-cid-6iy73elr]{animation:5s ease-in-out infinite float}\n.custom-scrollbar[data-astro-cid-ia7vokjv]::-webkit-scrollbar{width:6px}.custom-scrollbar[data-astro-cid-ia7vokjv]::-webkit-scrollbar-track{background:0 0}.custom-scrollbar[data-astro-cid-ia7vokjv]::-webkit-scrollbar-thumb{background:#ffffff1a;border-radius:10px}.custom-scrollbar[data-astro-cid-ia7vokjv]:hover::-webkit-scrollbar-thumb{background:#fff3}@keyframes dash{to{stroke-dashoffset:0}}@keyframes float{0%,to{transform:translateY(0)}50%{transform:translateY(-15px)}}@keyframes shimmer{to{transform:translate(100%)}}.animate-float{animation:6s ease-in-out infinite float}.animate-float-delayed{animation:6s ease-in-out 3s infinite float}.animate-shimmer{animation:3s linear infinite shimmer}\n"}],"routeData":{"route":"/seo","isIndex":false,"type":"page","pattern":"^\\/seo\\/?$","segments":[[{"content":"seo","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/seo.astro","pathname":"/seo","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/BaseLayout.B1XsQ0Jv.css"},{"type":"external","src":"_astro/index.lsujyfgF.css"},{"type":"inline","content":"@keyframes float{0%,to{transform:translateY(0)}50%{transform:translateY(-10px)}}.animate-float[data-astro-cid-6iy73elr]{animation:5s ease-in-out infinite float}\n"}],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","site":"https://croilab.com","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["C:/Users/bdela/Desktop/Croilab/src/pages/blog/[slug].astro",{"propagation":"none","containsHead":true}],["C:/Users/bdela/Desktop/Croilab/src/pages/blog/index.astro",{"propagation":"none","containsHead":true}],["C:/Users/bdela/Desktop/Croilab/src/pages/casos/[slug].astro",{"propagation":"none","containsHead":true}],["C:/Users/bdela/Desktop/Croilab/src/pages/contacto.astro",{"propagation":"none","containsHead":true}],["C:/Users/bdela/Desktop/Croilab/src/pages/conversiones.astro",{"propagation":"none","containsHead":true}],["C:/Users/bdela/Desktop/Croilab/src/pages/diseno-web.astro",{"propagation":"none","containsHead":true}],["C:/Users/bdela/Desktop/Croilab/src/pages/ecommerce.astro",{"propagation":"none","containsHead":true}],["C:/Users/bdela/Desktop/Croilab/src/pages/equipo.astro",{"propagation":"none","containsHead":true}],["C:/Users/bdela/Desktop/Croilab/src/pages/gracias.astro",{"propagation":"none","containsHead":true}],["C:/Users/bdela/Desktop/Croilab/src/pages/index.astro",{"propagation":"none","containsHead":true}],["C:/Users/bdela/Desktop/Croilab/src/pages/marca-blanca.astro",{"propagation":"none","containsHead":true}],["C:/Users/bdela/Desktop/Croilab/src/pages/meta-ads.astro",{"propagation":"none","containsHead":true}],["C:/Users/bdela/Desktop/Croilab/src/pages/nosotros.astro",{"propagation":"none","containsHead":true}],["C:/Users/bdela/Desktop/Croilab/src/pages/portal-cliente.astro",{"propagation":"none","containsHead":true}],["C:/Users/bdela/Desktop/Croilab/src/pages/privacidad.astro",{"propagation":"none","containsHead":true}],["C:/Users/bdela/Desktop/Croilab/src/pages/proyectos.astro",{"propagation":"none","containsHead":true}],["C:/Users/bdela/Desktop/Croilab/src/pages/proyectos/[slug].astro",{"propagation":"none","containsHead":true}],["C:/Users/bdela/Desktop/Croilab/src/pages/seo.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"\u0000noop-middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_C-PI1Pas.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","@astrojs/vercel/entrypoint":"entry.mjs","\u0000virtual:astro:page:src/pages/casos/[slug]@_@astro":"chunks/_slug__BP32DuFg.mjs","\u0000virtual:astro:page:src/pages/proyectos/[slug]@_@astro":"chunks/_slug__CaSLVyvM.mjs","\u0000virtual:astro:page:src/pages/blog/[slug]@_@astro":"chunks/_slug__DYtDizLk.mjs","\u0000virtual:astro:page:src/pages/contacto@_@astro":"chunks/contacto_5K5PkgOX.mjs","\u0000virtual:astro:page:src/pages/conversiones@_@astro":"chunks/conversiones_BXVox82_.mjs","\u0000virtual:astro:page:src/pages/diseno-web@_@astro":"chunks/diseno-web_CuzkpFIT.mjs","\u0000virtual:astro:page:src/pages/ecommerce@_@astro":"chunks/ecommerce_B8XNccLw.mjs","\u0000virtual:astro:page:src/pages/equipo@_@astro":"chunks/equipo_l6PA2k1_.mjs","\u0000virtual:astro:page:node_modules/astro/dist/assets/endpoint/generic@_@js":"chunks/generic_MivR4inb.mjs","\u0000virtual:astro:page:src/pages/gracias@_@astro":"chunks/gracias_BVwclUam.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_UZtGvbYz.mjs","\u0000virtual:astro:page:src/pages/blog/index@_@astro":"chunks/index_hObP4llA.mjs","\u0000virtual:astro:page:src/pages/marca-blanca@_@astro":"chunks/marca-blanca_B5ojiM_I.mjs","\u0000virtual:astro:page:src/pages/meta-ads@_@astro":"chunks/meta-ads_D2EnQoXs.mjs","\u0000virtual:astro:page:src/pages/nosotros@_@astro":"chunks/nosotros_CoOMK49u.mjs","\u0000virtual:astro:page:src/pages/portal-cliente@_@astro":"chunks/portal-cliente_hnb0DooW.mjs","\u0000virtual:astro:page:src/pages/privacidad@_@astro":"chunks/privacidad_K0s3oH2g.mjs","\u0000virtual:astro:page:src/pages/proyectos@_@astro":"chunks/proyectos_D_aHd8j0.mjs","\u0000virtual:astro:page:src/pages/seo@_@astro":"chunks/seo_zwHkHkCd.mjs","C:/Users/bdela/Desktop/Croilab/node_modules/astro/dist/assets/services/sharp.js":"chunks/sharp_DqOEPqXm.mjs","C:/Users/bdela/Desktop/Croilab/src/components/AboutAgency.astro?astro&type=script&index=0&lang.ts":"_astro/AboutAgency.astro_astro_type_script_index_0_lang.FWczkQrx.js","C:/Users/bdela/Desktop/Croilab/src/layouts/BaseLayout.astro?astro&type=script&index=0&lang.ts":"_astro/BaseLayout.astro_astro_type_script_index_0_lang.G0adXzpt.js","C:/Users/bdela/Desktop/Croilab/src/components/ui/Calculator.astro?astro&type=script&index=0&lang.ts":"_astro/Calculator.astro_astro_type_script_index_0_lang.BMM_kCWY.js","C:/Users/bdela/Desktop/Croilab/src/components/CaseStudiesCarousel.astro?astro&type=script&index=0&lang.ts":"_astro/CaseStudiesCarousel.astro_astro_type_script_index_0_lang.C9avecRI.js","C:/Users/bdela/Desktop/Croilab/src/components/ClientPortal.astro?astro&type=script&index=0&lang.ts":"_astro/ClientPortal.astro_astro_type_script_index_0_lang.BaV1kHyz.js","C:/Users/bdela/Desktop/Croilab/src/components/CookieConsent.astro?astro&type=script&index=0&lang.ts":"_astro/CookieConsent.astro_astro_type_script_index_0_lang.DpybnskN.js","C:/Users/bdela/Desktop/Croilab/src/components/Faq.astro?astro&type=script&index=0&lang.ts":"_astro/Faq.astro_astro_type_script_index_0_lang.CXOZzB19.js","C:/Users/bdela/Desktop/Croilab/src/components/Header.astro?astro&type=script&index=0&lang.ts":"_astro/Header.astro_astro_type_script_index_0_lang.Bs3ciXPC.js","C:/Users/bdela/Desktop/Croilab/src/components/Hero.astro?astro&type=script&index=0&lang.ts":"_astro/Hero.astro_astro_type_script_index_0_lang.DwIFx33s.js","C:/Users/bdela/Desktop/Croilab/src/components/Projects.astro?astro&type=script&index=0&lang.ts":"_astro/Projects.astro_astro_type_script_index_0_lang.BnYmOtvq.js","C:/Users/bdela/Desktop/Croilab/src/components/SeoMetricsMockup.astro?astro&type=script&index=0&lang.ts":"_astro/SeoMetricsMockup.astro_astro_type_script_index_0_lang.Mf3PlTGY.js","C:/Users/bdela/Desktop/Croilab/src/components/SuccessCasesHome.astro?astro&type=script&index=0&lang.ts":"_astro/SuccessCasesHome.astro_astro_type_script_index_0_lang.BVsSMS6m.js","C:/Users/bdela/Desktop/Croilab/src/components/WebDesignMockup.astro?astro&type=script&index=0&lang.ts":"_astro/WebDesignMockup.astro_astro_type_script_index_0_lang.DxpJapQs.js","C:/Users/bdela/Desktop/Croilab/src/pages/blog/[slug].astro?astro&type=script&index=0&lang.ts":"_astro/_slug_.astro_astro_type_script_index_0_lang.CcyMdWw4.js","C:/Users/bdela/Desktop/Croilab/src/pages/conversiones.astro?astro&type=script&index=0&lang.ts":"_astro/conversiones.astro_astro_type_script_index_0_lang.PyocYvT6.js","C:/Users/bdela/Desktop/Croilab/src/pages/diseno-web.astro?astro&type=script&index=0&lang.ts":"_astro/diseno-web.astro_astro_type_script_index_0_lang.D_TYWBCz.js","C:/Users/bdela/Desktop/Croilab/src/pages/ecommerce.astro?astro&type=script&index=0&lang.ts":"_astro/ecommerce.astro_astro_type_script_index_0_lang.BQQe9sbk.js","C:/Users/bdela/Desktop/Croilab/src/pages/equipo.astro?astro&type=script&index=0&lang.ts":"_astro/equipo.astro_astro_type_script_index_0_lang.BH4JTftp.js","C:/Users/bdela/Desktop/Croilab/src/pages/gracias.astro?astro&type=script&index=0&lang.ts":"_astro/gracias.astro_astro_type_script_index_0_lang.BbfKKbM_.js","C:/Users/bdela/Desktop/Croilab/src/pages/meta-ads.astro?astro&type=script&index=0&lang.ts":"_astro/meta-ads.astro_astro_type_script_index_0_lang.Db3ND4iT.js","C:/Users/bdela/Desktop/Croilab/src/pages/nosotros.astro?astro&type=script&index=0&lang.ts":"_astro/nosotros.astro_astro_type_script_index_0_lang.BOZxMqdf.js","C:/Users/bdela/Desktop/Croilab/src/pages/portal-cliente.astro?astro&type=script&index=0&lang.ts":"_astro/portal-cliente.astro_astro_type_script_index_0_lang.kiNAYm-s.js","C:/Users/bdela/Desktop/Croilab/src/pages/proyectos.astro?astro&type=script&index=0&lang.ts":"_astro/proyectos.astro_astro_type_script_index_0_lang.CxL_ZgNN.js","C:/Users/bdela/Desktop/Croilab/src/pages/seo.astro?astro&type=script&index=0&lang.ts":"_astro/seo.astro_astro_type_script_index_0_lang.BNTlEPd3.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[["C:/Users/bdela/Desktop/Croilab/src/components/AboutAgency.astro?astro&type=script&index=0&lang.ts","var e=document.getElementById(`video-cover`),t=document.getElementById(`video-player`),n=document.getElementById(`youtube-iframe`);e&&t&&n&&e.addEventListener(`click`,()=>{e.style.display=`none`,t.classList.remove(`hidden`),n.src=`https://www.youtube.com/embed/J9-aEZ523bA?autoplay=1`});"],["C:/Users/bdela/Desktop/Croilab/src/components/ui/Calculator.astro?astro&type=script&index=0&lang.ts","(()=>{let e=document.querySelector(`.croi-calculator`);if(!e)return;let t=JSON.parse(e.getAttribute(`data-croi-config`)??`{}`),n=new Intl.NumberFormat(`es-CO`,{maximumFractionDigits:0}),r=new Intl.NumberFormat(`es-CO`,{maximumFractionDigits:1}),i=(e,t)=>t===`currency`?`$${n.format(Math.round(e))}`:t===`multi`?`${e.toFixed(1).replace(`.`,`,`)}x`:n.format(Math.round(e)),a=e=>{let t=Number(e.value),i=e.step<1?r.format(t):n.format(t);return e.prefix?`${e.prefix}${i}`:e.suffix?`${i}${e.suffix}`:i},o=e=>e<=10?[0,28,15.8,11,8.4,6.3,5,4.4,3.6,3,2.5][e]:1.2,s=(e,t)=>{switch(e){case`ecommerce`:{let e=t.visitas*t.convActual/100,n=t.visitas*t.convNueva/100;return{nuevoIngreso:n*t.ticket,ingresoActual:e*t.ticket,ventasNuevas:n,extraAnual:(n-e)*t.ticket*12}}case`meta-ads`:{let e=t.presupuesto/t.cpa,n=e*t.ticket;return{ingresos:n,roas:n/t.presupuesto,clientes:e,ganancia:n*(t.margen/100)-t.presupuesto}}case`web`:{let e=t.visitas*t.convActual/100,n=t.visitas*t.convNueva/100;return{leadsNuevos:n,leadsActuales:e,extraMes:n-e,extraAnual:(n-e)*12}}case`seo`:{let e=t.busquedas*o(Math.round(t.posicionActual))/100,n=t.busquedas*o(Math.round(t.posicionNueva))/100;return{visProyectadas:n,visActuales:e,extraMes:n-e,extraAnual:(n-e)*12}}case`conversiones`:{let e=t.trafico*t.convActual/100,n=t.trafico*t.convNueva/100;return{extraMes:(n-e)*t.valorCliente,convProyectadas:n,convActuales:e,extraAnual:(n-e)*t.valorCliente*12}}default:return{}}},c=()=>{let n={};e.querySelectorAll(`[data-range-key]`).forEach(e=>{n[e.dataset.rangeKey??``]=Number(e.value)}),t.inputs.forEach(t=>{let r=e.querySelector(`[data-value-key=\"${t.key}\"]`),i=e.querySelector(`[data-range-key=\"${t.key}\"]`);r&&(r.textContent=a({...t,value:n[t.key]})),i&&i.style.setProperty(`--fill`,`${(n[t.key]-t.min)/(t.max-t.min)*100}%`)});let r=s(t.mode,n);t.results.forEach(t=>{let n=e.querySelector(`[data-result-key=\"${t.key}\"]`);n&&(n.textContent=i(r[t.key]??0,t.format))})};e.querySelectorAll(`[data-range-key]`).forEach(e=>{e.addEventListener(`input`,c)}),c()})();"],["C:/Users/bdela/Desktop/Croilab/src/components/CaseStudiesCarousel.astro?astro&type=script&index=0&lang.ts","(()=>{let e=document.getElementById(`case-studies-carousel`);if(!e)return;let t=JSON.parse(e.getAttribute(`data-projects`)||`{}`),n=t.projects||[],r=t.accent||`#3b82f6`;if(!n.length)return;let i=e.querySelector(`.carousel-track`),a=e.querySelectorAll(`.carousel-item`),o=e.querySelectorAll(`[data-carousel-image]`),s=e.querySelectorAll(`[data-metric-index]`),c=e.querySelector(`[data-cta-link]`),l=e.querySelector(`[data-carousel-list]`);if(!i||!a.length||!o.length||!s.length||!c||!l)return;let u=0,d,f=n.length;function p(e){if(e===u)return;a.forEach((t,n)=>{let i=n===e;t.classList.toggle(`active`,i),t.classList.toggle(`inactive`,!i),t.classList.toggle(`opacity-40`,!i);let a=t.querySelector(`h3`);a&&(a.className=`font-serif italic text-4xl sm:text-5xl lg:text-[3.2rem] tracking-tight leading-none font-medium mb-3 transition-colors duration-500 ${i?`carousel-name-active`:`text-[#2a2a2a] hover:text-[#3a3a3a]`}`,a.style.color=i?r:``),t.querySelectorAll(`span`).forEach(e=>{e.className=`inline-flex items-center px-3.5 py-1 rounded-full text-[11px] font-normal tracking-wide transition-all duration-300 border ${i?`text-white/50 border-white/10 bg-white/[0.04]`:`text-white/20 border-white/[0.04] bg-transparent`}`})});let t=a[e],d=t.offsetHeight+32,f=l.offsetHeight,p=-(e*d)+f/2-t.offsetHeight/2;i.style.transform=`translateY(${p}px)`,o.forEach((t,n)=>{let r=t;r.className=n===e?`absolute inset-0 w-full h-full object-cover transition-all duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] opacity-100 scale-100`:`absolute inset-0 w-full h-full object-cover transition-all duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] opacity-0 scale-105`}),s.forEach(t=>{let i=parseInt(t.getAttribute(`data-metric-index`)||`0`),a=n[e].metrics[i];if(!a)return;let o=t.querySelector(`[data-metric-value]`),s=t.querySelector(`[data-metric-label]`);o&&(o.textContent=a.value,o.style.color=r),s&&(s.textContent=a.label)}),c.href=n[e].slug,u=e}function m(){p((u+1)%f)}d=setInterval(m,4e3),a.forEach((e,t)=>{e.addEventListener(`click`,()=>{clearInterval(d),p(t),d=setInterval(m,4e3)})}),e.addEventListener(`mouseenter`,()=>clearInterval(d)),e.addEventListener(`mouseleave`,()=>{d=setInterval(m,4e3)});let h=a[0],g=l.offsetHeight/2-h.offsetHeight/2;i.style.transform=`translateY(${g}px)`})();"],["C:/Users/bdela/Desktop/Croilab/src/components/CookieConsent.astro?astro&type=script&index=0&lang.ts","(()=>{let e=`croilab_cookie_consent`,t=document.getElementById(`cookie-consent`);if(!t)return;let n=t.querySelector(`[data-cookie-accept]`),r=t.querySelector(`[data-cookie-essential]`),i=t.querySelector(`[data-cookie-config]`),a=t.querySelector(`[data-cookie-config-panel]`),o=t.querySelector(`[data-cookie-save]`),s=t.querySelector(`[data-cookie-analytics]`),c=t.querySelector(`[data-cookie-marketing]`),l=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches;function u(){let t=document.cookie.match(`(?:^|;)\\\\s*`+e+`=([^;]*)`);return t?decodeURIComponent(t[1]):null}function d(t){let n=encodeURIComponent(JSON.stringify(t)),r=new Date(Date.now()+31536e6).toUTCString();document.cookie=`${e}=${n}; expires=${r}; path=/; SameSite=Lax`;try{localStorage.setItem(e,n)}catch{}}function f(e){window.dispatchEvent(new CustomEvent(`cookiestatus-changed`,{detail:e}))}function p(){t.classList.add(`hidden`),t.style.display=`none`}function m(){l?t.style.display=`block`:(t.classList.remove(`hidden`),t.classList.add(`animate-cookie-in`),t.style.display=`block`)}function h(e){d(e),p()}let g=u();if(g)try{JSON.parse(g)}catch{}else m();n?.addEventListener(`click`,()=>{let e={essential:!0,analytics:!0,marketing:!0,updatedAt:Date.now()};h(e),f(e)}),r?.addEventListener(`click`,()=>{let e={essential:!0,analytics:!1,marketing:!1,updatedAt:Date.now()};h(e),f(e)}),i?.addEventListener(`click`,()=>{a.classList.toggle(`hidden`)}),o?.addEventListener(`click`,()=>{let e={essential:!0,analytics:s.checked,marketing:c.checked,updatedAt:Date.now()};h(e),f(e)})})();"],["C:/Users/bdela/Desktop/Croilab/src/components/Header.astro?astro&type=script&index=0&lang.ts","var e=document.getElementById(`site-header`);e&&window.addEventListener(`scroll`,()=>{window.scrollY>50?e.classList.add(`is-scrolled`):e.classList.remove(`is-scrolled`)});var t=document.getElementById(`menu-toggle`),n=document.getElementById(`mobile-menu`);if(t&&n){let e=()=>{t.classList.add(`is-open`),n.classList.add(`is-open`),t.setAttribute(`aria-expanded`,`true`),t.setAttribute(`aria-label`,`Cerrar menú`),n.setAttribute(`aria-hidden`,`false`),document.body.style.overflow=`hidden`},r=()=>{t.classList.remove(`is-open`),n.classList.remove(`is-open`),t.setAttribute(`aria-expanded`,`false`),t.setAttribute(`aria-label`,`Abrir menú`),n.setAttribute(`aria-hidden`,`true`),document.body.style.overflow=``};t.addEventListener(`click`,()=>{t.classList.contains(`is-open`)?r():e()}),n.querySelectorAll(`[data-close-menu]`).forEach(e=>e.addEventListener(`click`,r)),n.querySelectorAll(`a`).forEach(e=>e.addEventListener(`click`,r)),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&r()}),window.addEventListener(`resize`,()=>{window.innerWidth>=768&&r()})}"],["C:/Users/bdela/Desktop/Croilab/src/components/SuccessCasesHome.astro?astro&type=script&index=0&lang.ts","(()=>{let e=document.getElementById(`success-cases`);if(!e)return;let t=Array.from(e.querySelectorAll(`[data-tab]`)),n=Array.from(e.querySelectorAll(`[data-panel]`)),r=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches;function i(e){let t=parseFloat(e.getAttribute(`data-target`)||`0`);if(isNaN(t)||r){e.textContent=e.getAttribute(`data-target`)||`0`;return}let n=e.getAttribute(`data-target`)||`0`,i=n.includes(`.`)?n.split(`.`)[1].length:0,a=performance.now(),o=n=>{let r=Math.min((n-a)/1200,1),s=1-(1-r)**3;e.textContent=(t*s).toFixed(i),r<1&&requestAnimationFrame(o)};requestAnimationFrame(o)}function a(e){e.querySelectorAll(`.sc-pct-num`).forEach(i),e.querySelectorAll(`.sc-bar`).forEach((e,t)=>{if(r){e.style.height=e.style.getPropertyValue(`--h`);return}let n=e.style.getPropertyValue(`--h`);e.style.height=`0%`,requestAnimationFrame(()=>{setTimeout(()=>{e.style.transition=`height 900ms cubic-bezier(0.22,1,0.36,1) ${t*100}ms`,e.style.height=n},50)})})}function o(e){t.forEach((t,n)=>{let r=n===e;t.classList.toggle(`bg-black`,r),t.classList.toggle(`text-white`,r),t.classList.toggle(`border-black`,r),t.classList.toggle(`shadow-lg`,r),t.classList.toggle(`bg-white`,!r),t.classList.toggle(`text-black/60`,!r),t.classList.toggle(`border-black/10`,!r),t.setAttribute(`aria-selected`,String(r))}),n.forEach((t,n)=>{t.classList.toggle(`hidden`,n!==e)}),a(n[e])}t.forEach((e,t)=>{e.addEventListener(`click`,()=>o(t))}),a(n[0])})();"],["C:/Users/bdela/Desktop/Croilab/src/pages/gracias.astro?astro&type=script&index=0&lang.ts","document.addEventListener(`DOMContentLoaded`,()=>{document.querySelectorAll(`[data-elementor-type=\"popup\"], .dialog-widget, .dialog-lightbox-message, .elementor-popup-modal`).forEach(e=>e.remove()),document.body.classList.remove(`dialog-prevent-scroll`);let e=new URLSearchParams(window.location.search),t=(e.get(`nombre`)||``).trim(),n=(e.get(`web`)||``).trim(),r=(e.get(`sector`)||``).trim(),i=document.getElementById(`userName`);if(t&&i){let e=t.split(` `)[0];i.textContent=e.charAt(0).toUpperCase()+e.slice(1).toLowerCase()+`.`}else if(i){let e=i.previousElementSibling;e&&(e.textContent=`Gracias.`),i.style.display=`none`}let a=`¡Hola! Soy `+(t||`[tu nombre]`)+`. `;a+=`Acabo de dejar mis datos en la web para el diagnóstico gratuito`,n&&(a+=` (mi web: `+n+`)`),r&&(a+=`. Mi sector: `+r),a+=`. ¿Cuándo agendamos la llamada de 20 min?`;let o=`https://wa.me/34640188024?text=`+encodeURIComponent(a),s=document.getElementById(`whatsappBtn`);s&&s.setAttribute(`href`,o)});"]],"assets":["/croilab-logo.svg","/favicon.svg","/robots.txt","/images/favicon-192x192.png","/images/video-cover.jpg","/projects/ecommerce.svg","/projects/marketplace.svg","/projects/saas.svg","/_astro/BaseLayout.astro_astro_type_script_index_0_lang.G0adXzpt.js","/_astro/ClientPortal.astro_astro_type_script_index_0_lang.BaV1kHyz.js","/_astro/conversiones.astro_astro_type_script_index_0_lang.PyocYvT6.js","/_astro/diseno-web.astro_astro_type_script_index_0_lang.D_TYWBCz.js","/_astro/ecommerce.astro_astro_type_script_index_0_lang.BQQe9sbk.js","/_astro/equipo.astro_astro_type_script_index_0_lang.BH4JTftp.js","/_astro/Faq.astro_astro_type_script_index_0_lang.CXOZzB19.js","/_astro/gsap.CvDoa17S.js","/_astro/Hero.astro_astro_type_script_index_0_lang.DwIFx33s.js","/_astro/meta-ads.astro_astro_type_script_index_0_lang.Db3ND4iT.js","/_astro/nosotros.astro_astro_type_script_index_0_lang.BOZxMqdf.js","/_astro/portal-cliente.astro_astro_type_script_index_0_lang.kiNAYm-s.js","/_astro/Projects.astro_astro_type_script_index_0_lang.BnYmOtvq.js","/_astro/proyectos.astro_astro_type_script_index_0_lang.CxL_ZgNN.js","/_astro/ScrollTrigger.CDDhF-DF.js","/_astro/seo.astro_astro_type_script_index_0_lang.BNTlEPd3.js","/_astro/SeoMetricsMockup.astro_astro_type_script_index_0_lang.Mf3PlTGY.js","/_astro/WebDesignMockup.astro_astro_type_script_index_0_lang.DxpJapQs.js","/_astro/_slug_.astro_astro_type_script_index_0_lang.CcyMdWw4.js","/_astro/BaseLayout.B1XsQ0Jv.css","/_astro/index.lsujyfgF.css"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"945ER34m1TJ/m2bSgr9Mh+fPSAAuCMBjkbL1dJhNz6o=","image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "62c6c9db-73ec-4244-a3c0-485ffe27ea89") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
